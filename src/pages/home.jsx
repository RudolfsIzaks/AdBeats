...
function Home() {
    ...
    const handleSubmit = (e) => {
        ...
        // You can add further logic to send the data to a server or perform other actions
    };
        ...
        <>
            {loading ? (
                ...
                <div className="relative bg-black">
                    ...
                    <img src={questions[currentQuestion].sideImg} alt="" className="h-screen"/>
                    <form onSubmit={handleSubmit} className="p-10 rounded-md text-left w-3/5">
                            {currentQuestion < questions.length ? (
                                <div className="flex flex-col justify-between h-[60dvh] p-10">
                                    <div className="mb-4">
                                        ...
                                        {questions[currentQuestion].type === "text" || questions[currentQuestion].type === "email" || questions[currentQuestion].type === "url" ? (
                                            <input
                                    ...
                                    <div>
                                        <div className="bg-stone-800 rounded-md p-5 flex gap-5">
                                            <div className="bg-stone-500 w-36 rounded-md">
                                              <img src={questions[currentQuestion].image} alt="" className="w-36" />
                                            </div>
                                            <div>
                                                <img src={questions[currentQuestion].imageLogo} alt="" className="w-20" />
                                                <p className="text-white font-inter font-bold mt-5">{questions[currentQuestion].songName}</p>
                                                <audio src=""></audio>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="text-center">
                                    <p className="mb-4 text-gray-700">Thank you for completing the quiz!</p>
                                    <button
                                        type="submit"
